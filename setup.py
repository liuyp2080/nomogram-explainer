...
setup(
    name='pynomogram_explainer',  # 必填，项目的名字，用户根据这个名字安装，pip install SpiderKeeper-new
    version='1.0.0',  # 必填，项目的版本，建议遵循语义化版本规范
    author='Jeffery Liu',  # 项目的作者
    description='Drawing the nomogram with python, and explain the model with noomogram-drived data',  # 项目的一个简短描述
    ...
    url='https://github.com/liuyp2080/pynomogram_explainer',  # 项目的源码地址
    license='MIT',
